  ...
  describe ".scalar" do
    ...
    describe "#low" do
      ...
      it "expect to format" do
        expect(view_context).to receive(:st_number_to_currency).with(100_000) { "Low" }
    ...
    describe "#average" do
      ...
      it "expect to format" do
        expect(view_context).to receive(:st_number_to_currency).with(200_000) { "Avg" }
    ...
    describe "#high" do
      ...
      it "expect to format" do
        expect(view_context).to receive(:st_number_to_currency).with(250_000) { "High" }
